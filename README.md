...
This project explores the "Vector Illusion" in Retrieval-Augmented Generation (RAG). Most systems assume that if a piece of text mathematically matches a query, it’s the right answer. My research shows that's a dangerous assumption.
...
---
**Lina Ayaden** | Academic Year 2024-2025 | M1 I2D
